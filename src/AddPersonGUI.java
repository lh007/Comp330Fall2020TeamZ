...
public Person GUI(ArrayList<String> men, ArrayList<String> women, ArrayList<String> all, int currentID){ 
...
b1.addActionListener(new ActionListener(){  
    public void actionPerformed(ActionEvent e){ 
        ...
        //Otherwise, we go through and start to add all information to a String
        else{
            String msg="";
